...
function showScreen(id) {
  ...
  // Reset scroll setiap pindah halaman biar mobile nggak nyangkut/kepotong
...
function openLetter(i) {
  ...
  // Paksa halaman surat mulai dari atas, tapi tetap bisa scroll sampai bawah
  setTimeout(() => {
    window.scrollTo({ top: 0, left: 0, behavior: "auto" });
    const reader = $("#letterReader");
